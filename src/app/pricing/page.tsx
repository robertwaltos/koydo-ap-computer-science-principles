...
export const metadata: Metadata = {
  title: "Pricing — Ap Computer Science Principles Premium",
  description: "Unlock unlimited Ap Computer Science Principles practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ap-computer-science-principles&cadence=annual`;
