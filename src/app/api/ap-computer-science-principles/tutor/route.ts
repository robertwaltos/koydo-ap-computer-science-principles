...
const EXAM_ID = "ap-computer-science-principles";
const EXAM_DISPLAY_NAME = "AP Computer Science Principles";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Creative Development, Data, Algorithms & Programming, Computer Systems & Networks, and Impact of Computing. Align to College Board AP CSP CED.
