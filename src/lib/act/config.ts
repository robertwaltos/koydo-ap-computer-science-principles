// Auto-generated shim — re-exports from @/lib/ap-computer-science-principles/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _ap_computer_science_principles_Config } from "@/lib/ap-computer-science-principles/config";
import { EXAM_CONFIG as _raw } from "@/lib/ap-computer-science-principles/config";
